  ...
  useEffect(() => {
    ...
    if (!isVisible) {
      const resetTimer = window.setTimeout(() => {
        setIsVisualVisible(false); setIsAnnouncementVisible(false); setIsSpeechActive(false); setIsMoonVisible(false)
      }, 0)
    ...
    timersRef.current.push(window.setTimeout(() => setIsMoonVisible(true), HERO_STAGGER_STEP * 4))
